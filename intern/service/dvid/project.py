...
class ProjectService(DVIDService):
    ...
    def create(self, resource):
        ...
        if isinstance(resource, RepositoryResource):       
            if resource.UUID:
                raise ValueError("resource UUID must be None during resource creation. It will be autogenerated.")
            r = requests.post("{}/api/repos".format(self.base_url),
                data = json.dumps({"Alias" : resource.alias,
        ...
        if isinstance(resource, DataInstanceResource):
            ...
            data_instance_create_resp = requests.post("{}/api/repo/{}/instance".format(self.base_url, UUID),
    ...
    def delete(self, resource):
        ...
        if isinstance(resource, RepositoryResource):
            ...
            raise ValueError("resource type must be RepositoryResource or DataInstanceResource, was {}".format(resource))
        return del_resp